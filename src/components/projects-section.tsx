...
export default function Projects({
  ...
  return (
    <div className="relative xl:absolute xl:inset-0 z-20 pointer-events-none xl:pointer-events-none overflow-hidden flex xl:justify-end">
      ...
      <div
        className="w-full xl:w-[75vw] h-auto xl:h-full bg-[#0000FF] pointer-events-auto xl:border-l xl:border-white/20 shadow-none xl:shadow-2xl flex flex-col xl:flex-row disable-transform-on-mobile transition-transform duration-[400ms] ease-out"
        style={{
      ...
      >
        ...
        <div className="w-full xl:w-[60%] h-auto xl:h-screen relative xl:overflow-hidden">
          <div
            className="flex flex-col items-center xl:items-start w-full h-auto xl:h-max xl:min-h-screen p-6 lg:p-12 py-12 xl:pt-[10vh] xl:pb-[3vh] space-y-16 xl:space-y-32 disable-transform-on-mobile transition-transform duration-[400ms] ease-out"
            style={{
                ...
                return (
                  ...
                  >
                    <a
                      ...
                      className="w-full h-[50vh] sm:h-[70vh] lg:h-[50vh] xl:h-[70vh] 2xl:h-[60vh] bg-white/5 hover:bg-white/10 transition-colors border border-white/10 relative overflow-hidden flex items-center justify-center cursor-pointer"
                    >
